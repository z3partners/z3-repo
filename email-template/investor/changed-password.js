const changePassword = `<body style="background-color: #f3f3f3; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
...
<p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:14px;">Your Password is : [{password}]</span>. <br> You should change the password after login.</p>
</div>
</div>
</td>
</tr>
